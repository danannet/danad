...
// MsgDoneBlocksWithTrustedData implements the Message interface and represents a dana
...
// NewMsgDoneBlocksWithTrustedData returns a new dana DoneBlocksWithTrustedData message that conforms to the
// Message interface.
