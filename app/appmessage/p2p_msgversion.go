...
var DefaultUserAgent = fmt.Sprintf("/danad:%s/", version.Version())

// MsgVersion implements the Message interface and represents a dana version
...
// NewMsgVersion returns a new dana version message that conforms to the
