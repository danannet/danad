...
// MsgRequestTransactions implements the Message interface and represents a dana
...
// NewMsgRequestTransactions returns a new dana RequestTransactions message that conforms to
