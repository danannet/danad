...
// RPCTransaction is a danad transaction representation meant to be
// used over RPC
...
// RPCTransactionInput is a danad transaction input representation
...
// RPCScriptPublicKey is a danad ScriptPublicKey representation
type RPCScriptPublicKey struct {
	Version uint16
	Script  string
}

// RPCTransactionOutput is a danad transaction output representation
// meant to be used over RPC
...
// RPCOutpoint is a danad outpoint representation meant to be used
// over RPC
...
// RPCUTXOEntry is a danad utxo entry representation meant to be used
// over RPC
