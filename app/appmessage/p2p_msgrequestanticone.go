...
// MsgRequestAnticone implements the Message interface and represents a dana
...
// NewMsgRequestAnticone returns a new dana RequestPastDiff message that conforms to the
