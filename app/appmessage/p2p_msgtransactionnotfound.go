...
// MsgTransactionNotFound defines a dana TransactionNotFound message which is sent in response to
...
// NewMsgTransactionNotFound returns a new dana transactionsnotfound message that conforms to the
