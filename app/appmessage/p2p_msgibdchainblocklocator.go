...
// MsgIBDChainBlockLocator implements the Message interface and represents a dana
...
// NewMsgIBDChainBlockLocator returns a new dana locator message that conforms to
