...
// MsgRequestAddresses implements the Message interface and represents a dana
...
// NewMsgRequestAddresses returns a new dana RequestAddresses message that conforms to the
