...
// MsgRequestNextHeaders implements the Message interface and represents a dana
...
// NewMsgRequestNextHeaders returns a new dana RequestNextHeaders message that conforms to the
// Message interface.
