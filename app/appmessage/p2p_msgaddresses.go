...
// dana Addresses message (MsgAddresses).
const MaxAddressesPerMsg = 1000

// MsgAddresses implements the Message interface and represents a dana
// Addresses message.
...
// NewMsgAddresses returns a new dana Addresses message that conforms to the
