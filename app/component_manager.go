...
import (
	...
	"github.com/danannet/danad/app/protocol"
	"github.com/danannet/danad/app/rpc"
	"github.com/danannet/danad/domain"
	"github.com/danannet/danad/domain/consensus"
	"github.com/danannet/danad/domain/utxoindex"
	...
	"github.com/danannet/danad/infrastructure/network/connmanager"
	"github.com/danannet/danad/infrastructure/network/netadapter"
	"github.com/danannet/danad/infrastructure/network/netadapter/id"
	"github.com/danannet/danad/util/panics"
)

// ComponentManager is a wrapper for all the danad services
...
// Start launches all the danad services.
...
// Stop gracefully shuts down all the danad services.
func (a *ComponentManager) Stop() {
	// Make sure this only happens once.
	if atomic.AddInt32(&a.shutdown, 1) != 1 {
		log.Infof("Danad is already in the process of shutting down")
		return
	}

	log.Warnf("Danad shutting down")
