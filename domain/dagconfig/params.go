...
import (
	...
	"github.com/danannet/danad/util/network"
...
// Params defines a Dana network by its parameters. These parameters may be
// used by Dana applications to differentiate networks as well as addresses
...
type Params struct {
	...
	// Further details: https://hashdag.medium.com/dana-launch-plan-9a63f4d754a6
	...
	// PruningProofM is the 'm' constant in the pruning proof. For more details see: https://github.com/dananet/research/issues/3
...
// MainnetParams defines the network parameters for the main Dana network.
...
// TestnetParams defines the network parameters for the test Dana network.
var TestnetParams = Params{
	K:           defaultGHOSTDAGK,
	Name:        "dana-testnet-10",
	...
	// Human-readable part for Bech32 encoded addresses
	Prefix: util.Bech32PrefixDanaTest,
...
// SimnetParams defines the network parameters for the simulation test Dana
...
var SimnetParams = Params{
	...
	// Human-readable part for Bech32 encoded addresses
	Prefix: util.Bech32PrefixDanaSim,
...
// DevnetParams defines the network parameters for the development Dana network.
var DevnetParams = Params{
	...
	// Human-readable part for Bech32 encoded addresses
	Prefix: util.Bech32PrefixDanaDev,
...
// ErrDuplicateNet describes an error where the parameters for a Dana
// network could not be set due to the network already being a standard
// network or previously-registered into this package.
var ErrDuplicateNet = errors.New("duplicate Dana network")

var registeredNets = make(map[appmessage.DanaNet]struct{})

// Register registers the network parameters for a Dana network. This may
