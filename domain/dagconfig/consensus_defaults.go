...
const (
	...
	defaultSubsidyGenesisReward                    = 1 * constants.SompiPerDana
	defaultPreDeflationaryPhaseBaseSubsidy         = 500 * constants.SompiPerDana
	defaultDeflationaryPhaseBaseSubsidy            = 440 * constants.SompiPerDana
