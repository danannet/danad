...
func TestVirtualSelectedParentBlueScoreAndVirtualDAAScore(t *testing.T) {
	...
	response, err := danad.rpcClient.GetVirtualSelectedParentBlueScore()
	if err != nil {
	...
	err = danad.rpcClient.RegisterForVirtualSelectedParentBlueScoreChangedNotifications(
	...
	err = danad.rpcClient.RegisterForVirtualDaaScoreChangedNotifications(
