...
Clients are expected to build RequestMessages and wrap them in DanadMessage. (see messages.proto)

Having received a RequestMessage, (wrapped in a DanadMessage) the RPC server will respond with a
ResponseMessage (likewise wrapped in a DanadMessage) respective to the original RequestMessage.
