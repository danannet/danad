...
type P2P_MessageStreamClient interface {
	Send(*DanadMessage) error
	Recv() (*DanadMessage, error)
	grpc.ClientStream
}
...
func (x *p2PMessageStreamClient) Send(m *DanadMessage) error {
	return x.ClientStream.SendMsg(m)
}

func (x *p2PMessageStreamClient) Recv() (*DanadMessage, error) {
	m := new(DanadMessage)
...
func (x *p2PMessageStreamServer) Send(m *DanadMessage) error {
	return x.ServerStream.SendMsg(m)
}

func (x *p2PMessageStreamServer) Recv() (*DanadMessage, error) {
	m := new(DanadMessage)
...
func (x *rPCMessageStreamClient) Send(m *DanadMessage) error {
	return x.ClientStream.SendMsg(m)
}

func (x *rPCMessageStreamClient) Recv() (*DanadMessage, error) {
	m := new(DanadMessage)
	if err := x.ClientStream.RecvMsg(m); err != nil {
		return nil, err
	}
...
func (x *rPCMessageStreamServer) Send(m *DanadMessage) error {
	return x.ServerStream.SendMsg(m)
}

func (x *rPCMessageStreamServer) Recv() (*DanadMessage, error) {
	m := new(DanadMessage)
	if err := x.ServerStream.RecvMsg(m); err != nil {
		return nil, err
	}
