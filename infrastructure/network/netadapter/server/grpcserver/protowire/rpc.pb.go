...
// GetCurrentNetworkRequestMessage requests the network danad is currently running against.
//
...
type GetBlockTemplateResponseMessage struct {
	...
	// Whether danad thinks that it's synced.
	// Callers are discouraged (but not forbidden) from solving blocks when danad is not synced.
	// That is because when danad isn't in sync with the rest of the network there's a high
...
// GetPeerAddressesRequestMessage requests the list of known danad addresses in the
...
// currently connected to this danad.
...
type GetConnectedPeerInfoMessage struct {
	...
	// Whether this danad initiated the connection
	...
	// The timestamp of when this peer connected to this danad
...
// AddPeerRequestMessage adds a peer to danad's outgoing connection list.
// This will, in most cases, result in danad connecting to said peer.
...
// parent chain from some startHash to this danad's current virtual
...
// GetBlockCountRequestMessage requests the current number of blocks in this danad.
...
// ShutDownRequestMessage shuts down this danad.
...
//
// This call is only available when this danad was started with `--utxoindex`
//
...
// GetUtxosByAddressesRequestMessage requests all current UTXOs for the given danad addresses
//
// This call is only available when this danad was started with `--utxoindex`
