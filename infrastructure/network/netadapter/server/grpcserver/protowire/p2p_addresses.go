...
func (x *DanadMessage_Addresses) toAppMessage() (appmessage.Message, error) {
	if x == nil {
		return nil, errors.Wrap(errorNil, "DanadMessage_Addresses is nil")
	}
...
func (x *DanadMessage_Addresses) fromAppMessage(msgAddresses *appmessage.MsgAddresses) error {
