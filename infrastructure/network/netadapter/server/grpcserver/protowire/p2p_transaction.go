...
func (x *DanadMessage_Transaction) toAppMessage() (appmessage.Message, error) {
	if x == nil {
		return nil, errors.Wrapf(errorNil, "DanadMessage_Transaction is nil")
	}
	return x.Transaction.toAppMessage()
}

func (x *DanadMessage_Transaction) fromAppMessage(msgTx *appmessage.MsgTx) error {
