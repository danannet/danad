...
func (x *DanadMessage_Block) toAppMessage() (appmessage.Message, error) {
	if x == nil {
		return nil, errors.Wrap(errorNil, "DanadMessage_Block is nil")
	}
	return x.Block.toAppMessage()
}

func (x *DanadMessage_Block) fromAppMessage(msgBlock *appmessage.MsgBlock) error {
