...
import (
	...
	"github.com/danannet/danad/infrastructure/network/netadapter/server"
...
type grpcStream interface {
	Send(*protowire.DanadMessage) error
	Recv() (*protowire.DanadMessage, error)
}
...
func (c *gRPCConnection) receive() (*protowire.DanadMessage, error) {
...
func (c *gRPCConnection) send(message *protowire.DanadMessage) error {
