...
const (
	defaultConfigFilename      = "danad.conf"
	defaultLogLevel            = "info"
	defaultLogDirname          = "logs"
	defaultLogFilename         = "danad.log"
	defaultErrLogFilename      = "danad_err.log"
	...
	sampleConfigFilename    = "sample-danad.conf"
	defaultMaxUTXOCacheSize = 5_000_000_000
	defaultProtocolVersion  = 5
)

var (
	// DefaultAppDir is the default home directory for danad.
	DefaultAppDir = util.AppDir("danad", false)
...
// Flags defines the configuration options for danad.
//
...
// Config defines the configuration options for danad.
//
// See loadConfig for details on the configuration load process.
type Config struct {
	*Flags
...
// DefaultConfig returns the default danad configuration
...
//
// The above results in danad functioning properly without any config settings
...
// createDefaultConfig copies the file sample-danad.conf to the given destination path,
