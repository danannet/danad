...
import (
	...
	"github.com/danannet/danad/util/bech32"
)
...
var stringsToBech32Prefixes = map[string]Bech32Prefix{
	"dana":     Bech32PrefixDana,
	"danadev":  Bech32PrefixDanaDev,
	"danatest": Bech32PrefixDanaTest,
	"danasim":  Bech32PrefixDanaSim,
}
...
// and a payload which encodes the dana network and address type. It is used
