/*
Package util provides dana-specific convenience functions and types.

# Block Overview

A Block defines a dana block that provides easier and more efficient
...
A Tx defines a dana transaction that provides more efficient manipulation of
...
The Address interface provides an abstraction for a dana address. While the
most common type is a pay-to-pubkey, dana already supports others and
...
To decode/encode an address:
	...
	addrString := "dana:qqj9fg59mptxkr9j0y53j5mwurcmda5mtza9n6v9pm9uj8h0wgk6uma5pvumr"
	defaultPrefix := util.Bech32Prefixdana
